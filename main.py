...
Date: 2021
Title of program/source code: headPoseEstimation
Type: source code
Web address or publisher: https://github.com/niconielsen32/ComputerVision/blob/master/headPoseEstimation.py
'''
...
Author: Dharmaraj
Date: Jun 30, 2022
Title of program/source code: OpenCV Face Detection Deployment In Flask Web Framework
Type: computer program, source code
Web address or publisher: https://medium.com/@draj0718/opencv-face-detection-deployment-in-flask-web-framework-1a9b9772d9fd
'''
def generate_frames():
...
def download_csv_zip(user_id):
    ...
    Author: Sarika Singh
    Date: Aug 25, 2023
    Title of program/source code: How to create a zip file using Python?
    Type: source code
    Web address or publisher: https://www.tutorialspoint.com/how-to-create-a-zip-file-using-python
    '''
